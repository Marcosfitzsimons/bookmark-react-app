...
const ExtensionCard = ({ extensionImg, extensionName, versionMin }) => {
  return (
    <div className="card w-96 bg-very-dark-blue/20 shadow-xl mb-8 xl:first-of-type:relative xl:first-of-type:bottom-10 xl:last-of-type:relative xl:last-of-type:top-10">
      <figure className="px-10 pt-10">
        <img src={extensionImg} alt="browser" className="rounded-full" />
      </figure>
      <div className="card-body items-center text-center">
        <h2 className="card-title">Add to {extensionName}</h2>
        <p className="pb-8 text-base text-grayish-blue">
          Minimum version {versionMin}
        </p>
